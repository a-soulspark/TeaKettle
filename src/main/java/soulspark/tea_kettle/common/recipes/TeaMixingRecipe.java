...
public class TeaMixingRecipe implements IRecipe<IInventory> {
	...
	public static class Serializer extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<TeaMixingRecipe> {
		@Override
